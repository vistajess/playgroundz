...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoList = __webpack_require__(/*! ./TodoList */ 160);
	
	var _TodoList2 = _interopRequireDefault(_TodoList);
	
	var _TodoActions = __webpack_require__(/*! ./TodoActions */ 161);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_TodoActions2.default, { onHandleAdd: this.handleAddTodo }),
	        _react2.default.createElement(_TodoList2.default, { todos: this.state.todos, onDeleteTodo: this.handleDeleteTodo })
	      );
	    }
	  }, {
	    key: 'handleAddTodo',
	    value: function handleAddTodo(item) {
	      this.setState({
	        todos: [].concat(_toConsumableArray(this.state.todos), [item])
	      });
	    }
	  }, {
	    ...
	    value: function handleDeleteTodo(id) {
	      console.log(id);
	      this.setState({
	        todos: this.state.todos.filter(function (val, idx) {
	          return idx !== id;
	        })
	      });
	    }
	...
	var TodoList = (function (_React$Component) {
	  ...
	  _createClass(TodoList, [{
	        ...
	        this.props.todos.map(function (todo, key) {
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'button',
	              { onClick: _this2.handleDeleteClick(key) },
	              'x'
	            )
	          );
	        })
	    ...
	    value: function handleDeleteClick(id) {
	      ...
	      return function () {
	        console.log('clicked');
	        return _this3.props.onDeleteTodo(id);
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoActions = (function (_React$Component) {
	  _inherits(TodoActions, _React$Component);
	
	  function TodoActions(props) {
	    _classCallCheck(this, TodoActions);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoActions).call(this, props));
	  ...
	  _createClass(TodoActions, [{
	    ...
	    value: function handleAddClick() {
	      ...
	      return this.props.onHandleAdd(this.state.text);
	    }
	  }, {
	    key: 'handleChange',
	...
	TodoActions.propTypes = {
	  onHandleAdd: _react.PropTypes.func.isRequired
	};
