...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2016 at 08:02 PM
...
(8, 'Category 1', 'Category Details 1        			'),
...
--
ALTER TABLE `tblcategory`
  MODIFY `category_id` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `tbltag`
  MODIFY `tag_id` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
